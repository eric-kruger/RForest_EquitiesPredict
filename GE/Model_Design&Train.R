# Directory Setup
  source("~/R/RForest_EquitiesPredict/GE/SETUP.R") # e.g. source("~/R/RForest_EquitiesPredict/VEU/SETUP.R")         
  FROM             <- "2001-01-01"
  TO.model         <- "2017-08-29"
  TO.predict       <- Sys.Date()
  stock2model      <- "GE"              # e.g. "VEU"
  symbols          <- c("GE")                    # e.g. c("VEU")
  Market           <- "NYSE"   # e.g. "NYSEARCA"
