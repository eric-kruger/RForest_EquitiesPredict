# Directory Setup
  source("~/R/RForest_EquitiesPredict/GT/SETUP.R") # e.g. source("~/R/RForest_EquitiesPredict/VEU/SETUP.R")         
  FROM             <- "2001-01-01"
  TO.model         <- "2017-08-29"
  TO.predict       <- Sys.Date()
  stock2model      <- "GT"              # e.g. "VEU"
  symbols          <- c("GT")                    # e.g. c("VEU")
  Market           <- "NASDAQ"   # e.g. "NYSEARCA"
