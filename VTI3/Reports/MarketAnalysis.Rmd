...
# Model Performance
  perf <- stock.RF.performance(predict.obj=pred,sell.max = -0.01,stay.max = 0.01,buy.max = 99,sell.t=0.50,buy.t=0.50)
...
# Create Prediction Data Frame (Table)
  ...
  prediction[,3:10] <- round(prediction[,3:10],3)
